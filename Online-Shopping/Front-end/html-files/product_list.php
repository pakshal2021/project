					...
					<div class="col-sm-9 padding-right">
						<div class="features_items"><!--features_items-->
							...
							<?php 
								...
								$productsData = array(); 
								$pName = !empty($_REQUEST['product_name']) ? $_REQUEST['product_name'] : null;

								
								if ($subCatId) {
									$qry = $conn->query("SELECT * FROM product_detail where subcat_id = {$subCatId}");
								} elseif ($pName) {								
									$qry = $conn->query("SELECT * FROM product_detail where `product_name` LIKE '%{$pName}%'");
								} else {
										...
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="../../Back-end/images/products/<?php echo $_product['product_img']?>" alt="" width="100pxl" height="300pxp"/>
