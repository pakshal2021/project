                ...
                <div class="container">
                  ...
                  <tbody>   
                    ...
                    <tr>
                      ...
                      <td><a class="btn btn-danger" href="delete_feedback.php?id=<?php echo $_user['feedback_id']?>" onclick="return confirm('Are you sure you want to delete this record?')">Delete</a></td>
                    </tr>
                  <?php endforeach;?>
                  </tbody>
                </table>
