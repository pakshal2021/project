    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <?php     
              $adminUserData = array();         
              $qry = $conn->query("SELECT * FROM tbl_feedback");
                ...
                <div class="container">
                  ...
                  <tbody>   
                    ...
                    <tr>
                      ...
                      <td><a class="btn btn-primary" href="delete_feedback.php?id=<?php echo $_user['feedback_id']?>" onclick="return confirm('Are you sure you want to delete this record?')">Delete</a></td>
                    </tr>
                  <?php endforeach;?>
                  </tbody>
                </table>
