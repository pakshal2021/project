                ...
                <div class="card-body">
                  <form method="post"  action="../php-files/save_sub_category.php?sub_category_id=<?php echo $subCategoryId?>">
                    <div class="form-group">
                      <div class="">
                      <label for="sub_category_desc">Select Category</label>
                     ...
                     <div class="form-group">
                      ...
                      <label for="sub_category">Sub Category</label>
                        <input type="text" id="sub_category" class="form-control" value="" name="sub_category" required="required">
                      </div>
                    </div> 
                     <div class="form-group">
                      <div class="">                        
                      <label for="sub_category_desc">Sub Category Description</label>
                        <textarea rows="3" cols="10"  id="sub_category_desc" class="form-control" name="sub_category_desc" required="required"></textarea>
                      </div>
                    </div>                
